...
from .routers import ai_health, aliases, autocomplete, documents, products, push, stores, visits
...
app.include_router(ai_health.router, prefix="/api/ai-health", tags=["ai-health"])
